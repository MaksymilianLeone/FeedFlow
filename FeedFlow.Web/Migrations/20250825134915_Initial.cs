        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastBuiltAt = table.Column<DateTimeOffset>(type: "datetimeoffset", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Feeds", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Feeds_Orgs_OrgId",
                        column: x => x.OrgId,
                        principalTable: "Orgs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_BuildRuns_Feeds_FeedId",
                        column: x => x.FeedId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BuildRuns_FeedId",
                table: "BuildRuns",
                column: "FeedId");

            migrationBuilder.CreateIndex(
                name: "IX_Feeds_OrgId_Channel",
                table: "Feeds",
                columns: new[] { "OrgId", "Channel" });

            migrationBuilder.CreateIndex(
                name: "IX_Products_OrgId_Sku",
                table: "Products",
                columns: new[] { "OrgId", "Sku" },
                unique: true);
        }
